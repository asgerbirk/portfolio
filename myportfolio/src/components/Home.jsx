        ...
        <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row">
            <div className=" flex flex-col justify-center h-full flex gap-4">
                ...
                <p className="max-w-md mx-auto mt-2">
                    I am 24 years old, living in Nørrebro in Copenhagen and I'm searching for a 10-week unpaid internship. In my spare time I like to hang out with my friends, family and girlfriend.
                    I am a competitive person and I enjoy all kind of sports and especially football. At the moment I play a lot of padel tennis and go to the gym.
